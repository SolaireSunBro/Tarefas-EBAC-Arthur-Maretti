...
import br.com.Arthas.dao.ClienteDAO;
import br.com.Arthas.dao.ClienteDAO2;

public class Cliente2BancosDaoTest {

	
	private IClienteDAO<Cliente> clienteDao;
	
	private IClienteDAO<Cliente> clienteDaoDb2;
	
	private Random rd;

	public Cliente2BancosDaoTest() {
		this.clienteDao = new ClienteDAO();
		this.clienteDaoDb2 = new ClienteDAO2();
		this.rd = new Random();
	}
	...
	public void end() throws DAOException {
		...
		Collection<Cliente> list2 = clienteDaoDb2.buscarTodos();
		excluir2(list2);
	}
	...
	public void pesquisarCliente() throws TipoChaveNaoEncontradaException, DAOException, MaisDeUmRegistroException, TableException {
		...
		Cliente clienteConsultado2 = clienteDaoDb2.consultar(cliente.getId());
